...
//Create random files with some content
//create md5sum.txt which contains hash and file name whose hash is mentioned space separated and each such entry is present is new line
//6c6427da7893932731901035edbb9214  abcd.log
